...
parser = argparse.ArgumentParser(description="Visualize a PPO-trained robot morphology")
parser.add_argument(
    "model_path", type=str, help="Path to the PPO model zip file (e.g., shelfArm.zip)"
)
args = parser.parse_args()

model_path = args.model_path.replace(".zip", "")  # Remove .zip if provided
...
# Using 4 links for visualization
numLinks = 4
