...
class QLearningAgent:
    """
    An agent that learns to solve the Cliff Walking environment using the Q-Learning algorithm.
    """
    ...
    def update(self, state, action, reward, next_state):
        """
        Updates the Q-table using the Q-Learning (SARSAMAX) update rule. This is an off-policy method.
        The update rule is:
